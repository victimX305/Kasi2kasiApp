...
@Component({
  selector: 'app-verify-pro',
  templateUrl: './verify-pro.page.html',
  styleUrls: ['./verify-pro.page.scss'],
})
export class VerifyProPage implements OnInit {
  user: any;
  unverifiedUsers: any[]=[];
  ...
  async verifyUser(uid: string) {
    ...
    // Find the document in EventOrganizers collection based on UID
