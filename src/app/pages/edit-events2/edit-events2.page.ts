...
@Component({
  selector: 'app-edit-events2',
  templateUrl: './edit-events2.page.html',
  styleUrls: ['./edit-events2.page.scss'],
})
export class EditEvents2Page implements OnInit {
          ...
          this.firestore
            ...
            .subscribe((event: any) => {
              ...
              if (event && event.organizer === userEmail) {
                ...
                this.router.navigate(['/manage-events2']);
              }
            });
        }
      });
